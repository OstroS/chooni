	...
	<div class="container">
		...
		<form:form action="./add" method="POST" class="form-addkind">
			<div class="control-group">
				<div class="controls">
					<h2 class="form-signin-heading">Add Kind</h2>
				</div>
			</div>
			...
			<div class="control-group">
			<c:forEach items="${currentKinds}" var="kind">
				<span>${kind}</span>
			</c:forEach>
</div>
			<div class="control-group">
				<div class="controls">
					<button type="submit" value="Add Kind"
						class="btn btn-large btn-primary">Add Kind</button>
				</div>
			</div>
		</form:form>
	</div>
